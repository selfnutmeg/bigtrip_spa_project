...
const createEventTemplate = ({type, destination, fromDate, toDate, price, offers, isFavorite}) => (
  `<li class="trip-events__item">
    <div class="event">
      <time class="event__date" datetime="${formatDate(fromDate, 'YYYY-MM-DD')}">${formatDate(fromDate, 'MMM DD')}</time>
      ...
      <div class="event__schedule">
        <p class="event__time">
          <time class="event__start-time" datetime="${formatDate(fromDate, 'YYYY-MM-DDTHH:mm')}">${formatDate(fromDate, 'HH:mm')}</time>
          &mdash;
